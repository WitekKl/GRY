...
ksztalt1 = [[1,5,9,13],[4,5,6,7],[6,10,13,14], [4,8,9,10],[5,6,9,13],[4,5,6,10],[5,9,13,14],[8,9,10,6],[5,6,10,14],[8,9,10,12],[5,8,9,10],[5,9,10,13],[4,5,6,9],[6,9,10,14],[5,6,10,11],[6,9,10,13],[5,6,8,9],[5,9,10,14],[5,6,9,10  ]]
elementy = [[0,2],[2,4],[6,4],[10,4],[14,2],[16,2],[18,1]]
colors = (arcade.color.BABY_BLUE, arcade.color.ORANGE, arcade.color.GOLD, arcade.color.GRAY, arcade.color.GREEN , arcade.color.CYAN, arcade.color.PURPLE, arcade.color.ALABAMA_CRIMSON,arcade.color.AVOCADO , arcade.color.BLUEBONNET,arcade.color.DARK_PASTEL_GREEN )
...
# napisy na koniec gry
    ...
    def on_draw(self):
        ...
        if self.window.score >10:
            arcade.draw_text("Gratulacje, twoj wynik:  " + str(self.window.score), SCREEN_WIDTH / 2, 2 * SCREEN_HEIGHT / 3,
...
class GameView(arcade.View):
    ...
    def wynik(self):
        #napsiy o wyniku
        arcade.draw_text("Wynik: " + str(self.window.score),width/2 ,height/2, arcade.color.RED_BROWN, font_size=40, anchor_x="center", font_name="space/ok/Hardsign")
